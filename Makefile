...
build/all/batch:
	set CGO_ENABLED=0&& set GOOS=linux&& set GOARCH=386&& go build -ldflags="-s -w" -installsuffix cgo -o ./bin/${CLI_NAME}_linux_386.exe ./main.go
	set CGO_ENABLED=0&& set GOOS=linux&& set GOARCH=amd64&& go build -ldflags="-s -w" -installsuffix cgo -o ./bin/${CLI_NAME}_linux_amd64.exe ./main.go
...
build/all/bash:
	CGO_ENABLED=0 GOOS=linux GOARCH=386 go build -ldflags="-s -w" -installsuffix cgo -o ./bin/${CLI_NAME}_linux_386.exe ./main.go
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -installsuffix cgo -o ./bin/${CLI_NAME}_linux_amd64.exe ./main.go
